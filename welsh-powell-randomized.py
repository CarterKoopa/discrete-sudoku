...
from greedy import graph_sudoku, shuffle_dict


def welsh_powell(graph, vertex_mapping, attempts=0):
    """
    ...
    Args:
        ...
        attempt: int to track number of attempts
    """
    # Create a copy of the original vertex mapping
